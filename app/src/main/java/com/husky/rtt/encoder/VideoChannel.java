...
import com.husky.rtt.encoder.listener.OnVideoEncoderCallback;
...
public class VideoChannel {
    ...
    private OnSocketServerCallback onSocketServerCallback;

    public VideoChannel(Context context, OnSocketServerCallback onSocketServerCallback) {
        this.mContext = context;
        this.onSocketServerCallback = onSocketServerCallback;
    }
...
//                    FileUtils.writeContent(StorageUtil.getExternalFilesDir(mContext, null) + File.separator + "projection.h264", h264Frame);
    ...
    private void pushFrame(ByteBuffer byteBuffer, MediaCodec.BufferInfo bufferInfo) {
        ...
        // 回调编码好的数据
        if (onSocketServerCallback != null && newBytes != null) {
            onSocketServerCallback.onSendMessage(newBytes);
        }
    }
